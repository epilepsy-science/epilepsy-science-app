    ...
    <div v-if="hasData" class="widget-body">
      <div class="donut-wrap">
        ...
        <div class="donut-center">
          <div class="donut-center-total">{{ centerTotal }}</div>
          <div class="donut-center-caption">{{ centerCaption }}</div>
        </div>
      </div>
      <ul class="legend">
        <li
...
const props = defineProps({
  ...
  centerTotal: { type: Number, required: true },
  centerCaption: { type: String, default: 'patients' },
})
...
// The donut arcs are always drawn relative to the sum of the segment counts so
// they fill the full circle. The number shown in the center (centerTotal) is a
// separate prop, since some widgets display a broader total than the segments
// represent (e.g. MRI shows all patients but only charts the known-status ones).
