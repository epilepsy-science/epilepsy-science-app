export default {
  ...
  env: {
    ...
    ALGOLIA_INDEX: process.env.ALGOLIA_INDEX || 'epilepsy.science.old',
    ALGOLIA_INDEX_PUBLISHED_TIME_DESC: process.env.ALGOLIA_INDEX_PUBLISHED_TIME_DESC || process.env.ALGOLIA_INDEX,
    ALGOLIA_INDEX_PUBLISHED_TIME_ASC: process.env.ALGOLIA_INDEX_PUBLISHED_TIME_ASC || process.env.ALGOLIA_INDEX,
    ALGOLIA_INDEX_ALPHABETICAL_A_Z: process.env.ALGOLIA_INDEX_ALPHABETICAL_A_Z || process.env.ALGOLIA_INDEX,
    ALGOLIA_INDEX_ALPHABETICAL_Z_A: process.env.ALGOLIA_INDEX_ALPHABETICAL_Z_A || process.env.ALGOLIA_INDEX,
